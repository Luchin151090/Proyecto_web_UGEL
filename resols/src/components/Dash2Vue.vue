...
export default {
  data: () => ({
    ...
    steps:[
          {
            target :'.v-step-0',
            content:'Bienvenido Administrador a <strong>BuResol v1.0</strong>'
          },
          {
            target :'.v-step-1',
    ...
    items: [
      { title: "Inicio", icon: "mdi-home", route: "/admin" },
      {
        title: "Editar-Resol.",
        icon: "mdi-pencil",
        route: "/admin/administrar",
      },
      { title: "Busquedas", icon: "mdi-magnify", route: "/admin/busquedas" },
      { title: "Cuenta", icon: "mdi-account", route: "/admin/cuenta" },
      { title: "Admin-User", icon: "mdi-mouse", route: "/admin/edit_user" },
    ],
    drawer: null,
  }),
